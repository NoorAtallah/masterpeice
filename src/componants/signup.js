      ...
      <form className="form">
        ...
        <div className="flex-column">
            ...
            <div class="inputForm">
              ...
              <input placeholder="Enter your Full Name" class="input" type="text"/>
            </div>
        </div>
        ...
        <div className="flex-row">
          <button className="btn google" style={{color:'black'}}>
        ...
        <p className="p">Don't have an account? <span className="span">  <Link to='/login'>Sign In</Link></span></p>
